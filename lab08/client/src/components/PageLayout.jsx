...
export function FilmListLayout(props) {
  ...
  return (
    <>
      ...
      <FilmList films={filteredFilms} setDirty={props.setDirty}/>
...
export function EditLayout(props) {
  ...
  useEffect(() => {
    API.getFilmById(filmId)
      .then(film => setEditableFilm(film))
  ...
  return(!editableFilm ?
    ...
    : <Row><Col><FilmForm film={editableFilm} setDirty={props.setDirty} editFilm={true}/></Col></Row>
  );
}
