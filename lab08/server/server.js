...
const filmValidation = [
    ...
    check('isFavorite').isBoolean({ strict: false }).optional(),
...
app.post('/api/films',
    ...
    async (req, res) => {
        ...
        const film = new Film(undefined, req.body.title, isFavorite, watchDate, rating, req.body.userId);
...
app.put('/api/films/:id',
    ...
    async (req, res) => {
        ...
        const film = new Film(Number(req.params.id), req.body.title, req.body.isFavorite, req.body.watchDate, req.body.rating, req.body.userId);
...
app.put('/api/films/:id/favorite',
    [
        check('isFavorite').isBoolean({ strict: false }),
    ],
    async (req, res) => {
        const invalidFields = validationResult(req);
        ...
        try {
            ...
            film.isFavorite = req.body.isFavorite;  // update favorite property
            const result = await filmDao.updateFilm(film.id, film);
